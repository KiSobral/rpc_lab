...
prog_110011(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case findSmallest:
		...
		local = (char *(*)(char *, struct svc_req *)) findsmallest_110011_svc;
		break;

	case findGreatest:
		_xdr_argument = (xdrproc_t) xdr_operandos;
		_xdr_result = (xdrproc_t) xdr_float;
		local = (char *(*)(char *, struct svc_req *)) findgreatest_110011_svc;
		break;
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, PROG, VERS, prog_110011, IPPROTO_UDP)) {
	...
	if (!svc_register(transp, PROG, VERS, prog_110011, IPPROTO_TCP)) {
